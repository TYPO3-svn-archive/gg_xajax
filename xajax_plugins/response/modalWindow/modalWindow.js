...
*/
	...
	xjxmW.closeWindow = function( command )
	{
		var objDoc = document;
		...
		{	
			...
			{	
				command = {frame:'parent'};
			}
		
			objDoc = command.frame == 'parent' ? parent.document : parent.frames[command.frame].document;	
		}
		...
		{
			objElement.parentNode.removeChild(objElement);
			xjxmW.tools.hideSelects( objDoc ); 
		}
